...
Add Noelclaw as an MCP skill in Hermes. Once connected, all 81 tools are available directly in your agent conversations.
...
You should see all 81 tools listed — including `get_market_data`, `memory_search`, `swap_tokens`, `noel_boot`, `miroshark_simulate`, and more.
