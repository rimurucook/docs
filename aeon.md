...
The noelclaw skill pack is live in the Aeon ecosystem (merged PR #253). Once added, all 36 Noelclaw tools are available in Hermes and the Aeon agent runtime.
...
You should see all 36 noelclaw tools listed.
...
```
start_swarm
write_swarm_memory agentId: "workflow-executor" key: "task" value: "analyze BTC trend"
get_swarm_status
...
Use task packets and playbooks to give Aeon agents structured, Sentinel-gated execution:

```
create_task_packet name: "..." description: "..." territory: ["market", "defi"] permissions: ["read", "swap"]
list_playbooks
...
- All 36 tools are available — no Aeon-specific limitations
